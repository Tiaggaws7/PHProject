...
<?php
    ...
    for($i = 0; $i <= $nb_cd - 1; $i++ ){
        if ($bdd->CD[$i]->id == $id ){
            ...
            $imageReduite = $bdd->CD[$i]->imageReduite;
            ...
            finsert_ligne("bdd_xml_panier.php", "<imageReduite>$imageReduite</imageReduite> ", $line); $line++;
            finsert_ligne("bdd_xml_panier.php", "</CD>", $line);
...
?>
<a class="go_back" href="home.php">retourner à la page d'accueil</a>